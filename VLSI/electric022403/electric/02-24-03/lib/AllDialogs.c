...
{
 /*  1 */ {0, {552,292,576,372}, BUTTON, N_("OK")},
 /*  2 */ {0, {552,184,576,264}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {32,8,404,168}, SCROLL, x_("")},
 /*  4 */ {0, {32,176,544,380}, USERDRAWN, x_("")},
 ...
 /* 11 */ {0, {460,8,476,168}, MESSAGE, N_("Separate flat layers by:")},
 /* 12 */ {0, {480,96,496,168}, EDITTEXT, x_("0")},
 /* 13 */ {0, {508,28,532,148}, BUTTON, N_("Clean Up")}
};
static DIALOG us_3ddepthdialog = {{75,75,660,464}, N_("3D Options"), 0, 13, us_3ddepthdialogitems, 0, 0};

/* About Electric */
static DIALOGITEM us_aboutgnudialogitems[] =
{
 /*  1 */ {0, {24,320,48,400}, BUTTON, N_("Continue")},
...
static DIALOGITEM us_artworkdialogitems[] =
{
 ...
 /*  3 */ {0, {108,280,124,404}, RADIO, N_("Outlined Pattern")},
 ...
 /* 19 */ {0, {168,280,184,412}, POPUP, x_("")}
};
static DIALOG us_artworkdialog = {{50,75,349,497}, N_("Set Look of Highlighted"), 0, 19, us_artworkdialogitems, 0, 0};

/* Attribute Report */
static DIALOGITEM us_report_attrdialogitems[] =
{
 /*  1 */ {0, {12,8,28,100}, MESSAGE, N_("Attribute name:")},
 /*  2 */ {0, {12,104,28,200}, EDITTEXT, x_("")},
 /*  3 */ {0, {60,84,84,216}, DEFBUTTON, N_("Generate Report")},
 /*  4 */ {0, {36,32,52,100}, CHECK, N_("To file:")},
 /*  5 */ {0, {36,104,52,200}, EDITTEXT, x_("")},
 /*  6 */ {0, {60,8,84,76}, BUTTON, N_("Cancel")}
};
static DIALOG us_report_attrdialog = {{75,75,168,301}, N_("Attribute Report"), 0, 6, us_report_attrdialogitems, 0, 0};
...
{
 /*  1 */ {0, {240,344,264,416}, BUTTON, N_("OK")},
 /*  2 */ {0, {240,248,264,320}, BUTTON, N_("Cancel")},
 ...
 /*  7 */ {0, {8,8,236,223}, SCROLL, x_("")},
 /*  8 */ {0, {244,8,260,78}, MESSAGE, N_("Library:")},
 /*  9 */ {0, {244,80,260,218}, POPUP, x_("")},
 /* 10 */ {0, {188,232,204,438}, CHECK, N_("Ignore port names")},
 /* 11 */ {0, {212,232,228,438}, CHECK, N_("Allow missing ports")},
 /* 12 */ {0, {116,232,132,438}, CHECK, N_("Change nodes with arcs")},
 /* 13 */ {0, {140,232,156,438}, CHECK, N_("Show primitives")},
 /* 14 */ {0, {164,232,180,438}, CHECK, N_("Show facets")}
};
static DIALOG us_changedialog = {{50,75,323,522}, N_("Change Nodes and Arcs"), 0, 14, us_changedialogitems, 0, 0};
...
static DIALOGITEM us_txtmodsizedialogitems[] =
{
 ...
 /* 11 */ {0, {36,264,52,476}, RADIO, N_("Change all in this facet")},
 ...
 /* 22 */ {0, {56,264,72,476}, RADIO, N_("Change all facets with view:")},
...
static DIALOG us_tecedlibtotechdialog = {{75,75,204,456}, N_("Convert Library to Technology"), 0, 8, us_tecedlibtotechdialogitems, 0, 0};
...
static DIALOG us_portdialog = {{50,75,171,424}, N_("Create Export on Highlighted"), 0, 8, us_portdialogitems, 0, 0};

/* Cross-Library Copy */
static DIALOGITEM us_copyfacetdialogitems[] =
{
 /*  1 */ {0, {276,172,300,244}, BUTTON, N_("Done")},
 /*  2 */ {0, {8,8,24,171}, POPUP, x_("")},
 /*  3 */ {0, {276,40,300,112}, BUTTON, N_("<< Copy")},
 /*  4 */ {0, {276,296,300,368}, BUTTON, N_("Copy >>")},
 /*  5 */ {0, {32,8,264,172}, SCROLL, x_("")},
 /*  6 */ {0, {8,245,24,408}, POPUP, x_("")},
 /*  7 */ {0, {312,8,328,191}, BUTTON, N_("Examine contents")},
 /*  8 */ {0, {384,8,396,408}, MESSAGE, x_("")},
 /*  9 */ {0, {336,8,352,191}, BUTTON, N_("Examine contents quietly")},
 ...
 /* 15 */ {0, {360,8,376,191}, BUTTON, N_("List differences")}
};
static DIALOG us_copyfacetdialog = {{50,75,455,492}, N_("Cross-Library Copy"), 0, 15, us_copyfacetdialogitems, 0, 0};
...
{
 /*  1 */ {0, {352,152,376,216}, BUTTON, N_("OK")},
 /*  2 */ {0, {352,44,376,108}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {56,32,72,192}, CHECK, N_("Highlights errors")},
 /*  4 */ {0, {320,32,336,160}, BUTTON, N_("Edit Rules Deck")},
 /*  5 */ {0, {32,32,48,117}, CHECK, N_("On")},
 /*  6 */ {0, {112,32,128,192}, CHECK, N_("Use dialog")},
 /*  7 */ {0, {8,8,24,169}, MESSAGE, N_("Incremental DRC:")},
 /*  8 */ {0, {88,8,104,169}, MESSAGE, N_("Hierarchical DRC:")},
 /*  9 */ {0, {296,8,312,169}, MESSAGE, N_("Dracula DRC Interface:")},
 /* 10 */ {0, {160,32,176,192}, BUTTON, N_("Clear valid DRC dates")},
 /* 11 */ {0, {136,32,152,192}, CHECK, N_("Just 1 error per facet")},
 /* 12 */ {0, {264,32,280,272}, CHECK, N_("Ignore center cuts in large contacts")},
 /* 13 */ {0, {240,48,256,212}, MESSAGE, N_("Number of processors:")},
 /* 14 */ {0, {216,32,232,217}, CHECK, N_("Use multiple processors")},
 /* 15 */ {0, {240,216,256,272}, EDITTEXT, x_("")},
 /* 16 */ {0, {192,8,208,225}, MESSAGE, N_("Incremental and hierarchical:")},
 /* 17 */ {0, {80,8,81,272}, DIVIDELINE, x_("")},
 /* 18 */ {0, {184,8,185,272}, DIVIDELINE, x_("")},
 /* 19 */ {0, {288,8,289,272}, DIVIDELINE, x_("")},
 /* 20 */ {0, {344,8,345,272}, DIVIDELINE, x_("")}
};
static DIALOG dr_optionsdialog = {{50,75,435,356}, N_("DRC Options"), 0, 20, dr_optionsdialogitems, 0, 0};
...
static DIALOGITEM dr_rulesdialogitems[] =
{
 ...
 /* 42 */ {0, {192,112,208,296}, CHECK, N_("Show only lines with rules")},
 /* 43 */ {0, {56,8,72,95}, RADIO, N_("Nodes:")},
 /* 44 */ {0, {136,308,152,424}, MESSAGE, N_("Minimum Height:")},
 /* 45 */ {0, {136,454,152,502}, EDITTEXT, x_("")}
};
static DIALOG dr_rulesdialog = {{50,75,495,680}, N_("Design Rules"), 0, 45, dr_rulesdialogitems, 0, 0};

/* DRC error message */
static DIALOGITEM dr_errdialogitems[] =
{
 /*  1 */ {0, {88,40,112,104}, BUTTON, N_("OK")},
 /*  2 */ {0, {128,232,152,360}, BUTTON, N_("Stop Checking")},
 /*  3 */ {0, {88,184,112,312}, BUTTON, N_("Ignore this error")},
 /*  4 */ {0, {128,96,152,224}, BUTTON, N_("Continue Silently")},
 /*  5 */ {0, {8,8,76,360}, MESSAGE, x_("")},
 /*  6 */ {0, {132,4,148,84}, MESSAGE|INACTIVE, N_("For now:")},
 /*  7 */ {0, {164,4,180,84}, MESSAGE|INACTIVE, N_("Permanently:")},
 /*  8 */ {0, {160,232,184,360}, BUTTON, N_("Stop Checking")},
 /*  9 */ {0, {160,96,184,224}, BUTTON, N_("Continue Silently")}
};
static DIALOG dr_errdialog = {{50,75,243,444}, N_("DRC Violation"), 0, 9, dr_errdialogitems, 0, 0};

/* DRC hierarchical interactive dialog */
static DIALOGITEM dr_hierdialogitems[] =
{
 /*  1 */ {0, {8,8,32,72}, BUTTON, N_("Check")},
 /*  2 */ {0, {8,344,32,408}, BUTTON, N_("Done")},
 /*  3 */ {0, {38,8,132,408}, MESSAGE, x_("")},
 /*  4 */ {0, {8,214,32,326}, BUTTON, N_("Show Prev Error")},
 /*  5 */ {0, {8,94,32,206}, BUTTON, N_("Show Next Error")}
};
static DIALOG dr_hierdialog = {{50,75,191,492}, N_("Hierarchical DRC"), 0, 5, dr_hierdialogitems, 0, 0};
...
/* Edit Facet */
static DIALOGITEM us_editfacetdialogitems[] =
{
 /*  1 */ {0, {292,208,316,272}, BUTTON, N_("OK")},
 /*  2 */ {0, {292,16,316,80}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {32,8,208,281}, SCROLL, x_("")},
...
static DIALOG us_editfacetdialog = {{50,75,375,365}, N_("Edit Facet"), 0, 9, us_editfacetdialogitems, 0, 0};
...
{
 /*  1 */ {0, {444,152,468,232}, BUTTON, N_("OK")},
 /*  2 */ {0, {444,32,468,112}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {140,22,156,198}, CHECK, N_("Show only this view:")},
 /*  4 */ {0, {160,38,176,214}, POPUP, x_("")},
 /*  5 */ {0, {180,22,196,198}, CHECK, N_("Also include icon views")},
 /*  6 */ {0, {232,22,248,198}, CHECK, N_("Exclude older versions")},
 /*  7 */ {0, {120,10,136,186}, MESSAGE, N_("View filter:")},
 /*  8 */ {0, {212,10,228,186}, MESSAGE, N_("Version filter:")},
 /*  9 */ {0, {252,22,268,198}, CHECK, N_("Exclude newest versions")},
 /* 10 */ {0, {8,8,24,184}, MESSAGE, N_("Which facets:")},
 /* 11 */ {0, {68,20,84,248}, RADIO, N_("Only those under current facet")},
 /* 12 */ {0, {284,8,300,184}, MESSAGE, N_("Display ordering:")},
 /* 13 */ {0, {304,20,320,248}, RADIO, N_("Order by name")},
 /* 14 */ {0, {324,20,340,248}, RADIO, N_("Order by modification date")},
 /* 15 */ {0, {344,20,360,248}, RADIO, N_("Order by skeletal structure")},
 /* 16 */ {0, {376,8,392,184}, MESSAGE, N_("Destination:")},
 /* 17 */ {0, {396,16,412,244}, RADIO, N_("Display in messages window")},
 /* 18 */ {0, {416,16,432,244}, RADIO, N_("Save to disk")},
 /* 19 */ {0, {48,20,64,248}, RADIO, N_("Only those used elsewhere")},
 /* 20 */ {0, {88,20,104,248}, RADIO, N_("Only placeholder facets")},
 /* 21 */ {0, {28,20,44,248}, RADIO, N_("All facets")},
 /* 22 */ {0, {112,8,113,248}, DIVIDELINE, x_("")},
 /* 23 */ {0, {204,8,205,248}, DIVIDELINE, x_("")},
 /* 24 */ {0, {276,8,277,248}, DIVIDELINE, x_("")},
 /* 25 */ {0, {368,8,369,248}, DIVIDELINE, x_("")}
};
static DIALOG us_faclisdialog = {{75,75,552,332}, N_("Facet Lists"), 0, 25, us_faclisdialogitems, 0, 0};
...
static DIALOGITEM us_facetdialogitems[] =
{
 ...
 /*  7 */ {0, {196,4,197,568}, DIVIDELINE, x_("")},
 ...
 /* 16 */ {0, {76,156,92,480}, CHECK, N_("Part of a cell-library")},
 ...
 /* 33 */ {0, {100,156,116,480}, CHECK, N_("Use technology editor on this facet")},
 /* 34 */ {0, {100,484,116,520}, BUTTON, N_("Set")},
 /* 35 */ {0, {100,528,116,568}, BUTTON, N_("Clear")}
};
static DIALOG us_facetdialog = {{50,75,427,653}, N_("Facet Options"), 0, 35, us_facetdialogitems, 0, 0};
...
static DIALOGITEM us_paramdialogitems[] =
{
 ...
 /*  3 */ {0, {28,8,196,208}, SCROLL, x_("")},
 /*  4 */ {0, {36,336,52,504}, EDITTEXT, x_("")},
 /*  5 */ {0, {60,336,92,504}, EDITTEXT, x_("")},
 /*  6 */ {0, {60,216,76,332}, MESSAGE, N_("Default Value:")},
 /*  7 */ {0, {132,216,156,352}, BUTTON, N_("Create Parameter")},
 /*  8 */ {0, {8,8,24,376}, MESSAGE, N_("Parameters on facet %s:")},
 /*  9 */ {0, {132,368,156,504}, BUTTON, N_("Delete Parameter")},
 /* 10 */ {0, {100,216,116,332}, MESSAGE, N_("Units:")},
 /* 11 */ {0, {100,336,116,504}, POPUP, x_("")}
};
static DIALOG us_paramdialog = {{75,75,280,588}, N_("Facet Parameters"), 0, 11, us_paramdialogitems, 0, 0};

/* Facet Selection */
static DIALOGITEM us_facetselectdialogitems[] =
{
...
static DIALOG us_facetselectdialog = {{50,75,419,364}, N_("Facet List"), 0, 8, us_facetselectdialogitems, 0, 0};
...
static DIALOGITEM sim_fasthenrydialogitems[] =
{
 ...
 /* 13 */ {0, {104,232,120,420}, CHECK, N_("Make PostScript view")},
 /* 14 */ {0, {80,232,96,420}, MESSAGE, N_("Maximum segment length:")},
 /* 15 */ {0, {80,424,96,480}, EDITTEXT, x_("")},
 /* 16 */ {0, {32,232,48,420}, MESSAGE, N_("Default width subdivisions:")},
 /* 17 */ {0, {32,424,48,480}, EDITTEXT, x_("")},
 /* 18 */ {0, {56,232,72,420}, MESSAGE, N_("Default height subdivisions:")},
 /* 19 */ {0, {56,424,72,480}, EDITTEXT, x_("")},
 /* 20 */ {0, {128,232,144,420}, CHECK, N_("Make SPICE subcircuit")},
 /* 21 */ {0, {8,232,24,420}, MESSAGE, N_("Default thickness:")},
 /* 22 */ {0, {8,424,24,480}, EDITTEXT, x_("")},
 /* 23 */ {0, {176,140,192,344}, POPUP, x_("")},
 /* 24 */ {0, {156,176,172,320}, MESSAGE, N_("After writing deck:")}
};
static DIALOG sim_fasthenrydialog = {{75,75,276,564}, N_("FastHenry Options"), 0, 24, sim_fasthenrydialogitems, 0, 0};
...
static DIALOGITEM us_txtsardialogitems[] =
{
 ...
 /*  4 */ {0, {8,76,24,388}, EDITTEXT, x_("")},
 /*  5 */ {0, {8,8,24,72}, MESSAGE, N_("Find:")},
 /*  6 */ {0, {36,76,52,388}, EDITTEXT, x_("")},
...
static DIALOG us_txtsardialog = {{75,75,232,472}, N_("Search and Replace"), 0, 14, us_txtsardialogitems, 0, 0};
...
static DIALOGITEM us_drawingoptdialogitems[] =
{
 ...
 /*  4 */ {0, {116,128,132,328}, EDITTEXT, x_("")},
 /*  5 */ {0, {140,16,156,125}, MESSAGE, N_("Designer Name:")},
 /*  6 */ {0, {140,128,156,328}, EDITTEXT, x_("")},
 /*  7 */ {0, {44,8,60,105}, MESSAGE, N_("Frame size:")},
 /*  8 */ {0, {44,108,60,204}, POPUP, x_("")},
 ...
 /* 13 */ {0, {80,8,81,328}, DIVIDELINE, x_("")},
 /* 14 */ {0, {164,16,180,125}, MESSAGE, N_("Project Name:")},
 /* 15 */ {0, {164,128,180,328}, EDITTEXT, x_("")}
};
static DIALOG us_drawingoptdialog = {{50,75,279,412}, N_("Frame Options"), 0, 15, us_drawingoptdialogitems, 0, 0};
...
static DIALOGITEM io_gdsoptionsdialogitems[] =
{
 ...
 /* 12 */ {0, {176,396,192,464}, EDITTEXT, x_("")},
 /* 13 */ {0, {200,250,216,394}, MESSAGE, N_("Maximum arc sag:")},
 /* 14 */ {0, {200,396,216,464}, EDITTEXT, x_("")},
 /* 15 */ {0, {104,240,120,464}, CHECK, N_("Input Ignores Unknown Layers")}
};
static DIALOG io_gdsoptionsdialog = {{50,75,307,548}, N_("GDS Options"), 0, 15, io_gdsoptionsdialogitems, 0, 0};

/* General Options */
static DIALOGITEM us_genoptdialogitems[] =
{
 /*  1 */ {0, {132,252,156,332}, BUTTON, N_("OK")},
 /*  2 */ {0, {132,152,156,232}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {8,8,24,216}, CHECK, N_("Beep after long jobs")},
 /*  4 */ {0, {80,8,96,308}, CHECK, N_("Include date and version in output files")},
 /*  5 */ {0, {132,44,156,124}, BUTTON, N_("Advanced")},
 /*  6 */ {0, {104,8,120,284}, MESSAGE, N_("Maximum errors to report (0 for infinite):")},
 /*  7 */ {0, {104,288,120,360}, EDITTEXT, x_("")},
...
static DIALOG us_genoptdialog = {{75,75,240,445}, N_("General Options"), 0, 9, us_genoptdialogitems, 0, 0};
...
{
 /*  1 */ {0, {256,376,280,448}, BUTTON, N_("OK")},
 /*  2 */ {0, {256,284,280,356}, BUTTON, N_("Cancel")},
 ...
 /* 15 */ {0, {256,192,280,264}, BUTTON, N_("Attributes")},
 ...
 /* 39 */ {0, {256,8,280,80}, BUTTON, N_("See Node")},
 /* 40 */ {0, {256,100,280,172}, BUTTON, N_("Node Info")},
 /* 41 */ {0, {160,248,176,416}, POPUP, x_("")},
 /* 42 */ {0, {160,160,176,237}, MESSAGE, N_("Rotation:")},
 /* 43 */ {0, {232,160,248,449}, MESSAGE, x_("")}
};
static DIALOG us_portinfodialog = {{50,75,339,534}, N_("Export Information"), 0, 43, us_portinfodialogitems, 0, 0};
...
static DIALOGITEM us_shownodedialogitems[] =
{
 ...
 /* 25 */ {0, {180,220,196,392}, AUTOCHECK, N_("Only Visible Inside Facet")},
...
static DIALOG us_shownodedialog = {{50,75,568,478}, N_("Node Information"), 0, 42, us_shownodedialogitems, "shownode", 176};

/* special items for the "shownode" dialog: */
#define DGIN_NAME_L         1		/* Name (message) */
#define DGIN_TYPE_L         2		/* Type (message) */
#define DGIN_NAME           3		/* name (edittext) */
#define DGIN_TYPE           4		/* type (message) */
#define DGIN_YPOSITION      5		/* X position (edittext) */
...
#define DGIN_XPOSITION_L   10		/* X position (message) */
#define DGIN_XPOSITION     11		/* X position (edittext) */
#define DGIN_XSIZE         12		/* X size (edittext) */
#define DGIN_YPOSITION_L   13		/* Y position (message) */
#define DGIN_POSITION      14		/* Position information (message) */
#define DGIN_ROTATTION_L   15		/* Rotation (message) */
...
#define DGIN_VISINSIDE     25		/* Only visible inside facet (autocheck) */
#define DGIN_SPECIAL2_L    26		/* Special line 2 title (message) */
#define DGIN_SPECIAL1_L    27		/* Special line 1 title (message) */
#define DGIN_SPECIAL2      28		/* Special line 2 value (edittext) */
#define DGIN_SPECIAL1      29		/* Special line 1 value (popup) */
...
#define DGIN_PARATTREV     37		/* Parameter/attribute evaluation (edittext) */
#define DGIN_PARATTRLAN    38		/* Parameter/attribute language (popup) */
#define DGIN_PARATTR       39		/* Parameter/attribute value (message) */
...
static DIALOGITEM us_showtextdialogitems[] =
{
 ...
 /* 28 */ {0, {236,152,252,340}, CHECK, N_("Visible only inside facet")},
...
static DIALOGITEM us_visiblelaydialogitems[] =
{
 ...
 /* 11 */ {0, {180,242,196,394}, AUTOCHECK, N_("Facet text")},
...
static DIALOG us_visiblelaydialog = {{50,75,335,478}, N_("Layer Visibility"), 0, 17, us_visiblelaydialogitems, "visiblelay", 0};
...
#define DVSL_FACETTEXT    11		/* Show facet text (autocheck) */
...
{
 /*  1 */ {0, {448,224,472,312}, BUTTON, N_("Do NCC")},
 /*  2 */ {0, {448,8,472,72}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {324,4,340,200}, CHECK, N_("Recurse through hierarchy")},
 /*  4 */ {0, {228,4,244,220}, CHECK, N_("Check export names")},
 /*  5 */ {0, {448,96,472,201}, BUTTON, N_("Preanalysis")},
 /*  6 */ {0, {392,4,408,216}, CHECK, N_("Show progress graphically")},
 /*  7 */ {0, {108,4,124,220}, CHECK, N_("Merge parallel components")},
 /*  8 */ {0, {204,4,220,220}, CHECK, N_("Ignore power and ground")},
 /*  9 */ {0, {60,4,76,217}, MESSAGE, N_("For all facets:")},
 /* 10 */ {0, {175,228,387,400}, SCROLL, x_("")},
 /* 11 */ {0, {53,220,440,221}, DIVIDELINE, x_("")},
 ...
 /* 18 */ {0, {300,20,316,164}, MESSAGE, N_("Size tolerance (amt):")},
 /* 19 */ {0, {300,168,316,216}, EDITTEXT, x_("")},
 /* 20 */ {0, {52,4,53,401}, DIVIDELINE, x_("")},
 /* 21 */ {0, {60,228,76,400}, MESSAGE, N_("Individual facet overrides:")},
 /* 22 */ {0, {156,16,172,205}, BUTTON, N_("Clear NCC dates this library")},
 /* 23 */ {0, {252,4,268,220}, CHECK, N_("Check component sizes")},
 /* 24 */ {0, {4,136,20,305}, EDITTEXT, x_("")},
 /* 25 */ {0, {28,4,44,132}, MESSAGE, N_("With facet:")},
 /* 26 */ {0, {4,4,20,132}, MESSAGE, N_("Compare facet:")},
 /* 27 */ {0, {276,20,292,164}, MESSAGE, N_("Size tolerance (%):")},
 /* 28 */ {0, {276,168,292,216}, EDITTEXT, x_("")},
 /* 29 */ {0, {448,336,472,400}, BUTTON, N_("Save")},
 /* 30 */ {0, {440,4,441,400}, DIVIDELINE, x_("")},
 /* 31 */ {0, {416,240,432,389}, BUTTON, N_("Remove all overrides")},
 ...
 /* 40 */ {0, {155,228,171,400}, POPUP, x_("")},
 /* 41 */ {0, {392,240,408,389}, BUTTON, N_("List all overrides")},
 /* 42 */ {0, {416,4,432,216}, CHECK, N_("Show 'NCCMatch' tags")},
 /* 43 */ {0, {4,356,20,400}, BUTTON, N_("Next")},
 /* 44 */ {0, {28,356,44,400}, BUTTON, N_("Next")},
 /* 45 */ {0, {180,16,196,205}, BUTTON, N_("Clear NCC dates all libraries")},
 /* 46 */ {0, {348,4,364,152}, CHECK, N_("Experimental NCC")},
 /* 47 */ {0, {368,36,384,148}, MESSAGE, N_("Processors:")},
 /* 48 */ {0, {368,152,384,200}, EDITTEXT, x_("")}
};
static DIALOG net_nccoptionsdialog = {{50,75,531,486}, N_("Network Consistency Checker"), 0, 48, net_nccoptionsdialogitems, 0, 0};
...
static DIALOG net_nccpredialog = {{75,75,516,700}, N_("NCC Preanalysis Results"), 0, 10, net_nccpredialogitems, "nccpre", 0};
...
{
 /*  1 */ {0, {288,132,312,196}, BUTTON, N_("OK")},
 ...
 /* 10 */ {0, {148,4,149,226}, DIVIDELINE, x_("")},
 ...
 /* 14 */ {0, {100,20,116,226}, MESSAGE, N_("Unify Networks that start with:")},
 /* 15 */ {0, {124,32,140,226}, EDITTEXT, x_("")}
};
static DIALOG net_optionsdialog = {{50,75,371,311}, N_("Network Options"), 0, 15, net_optionsdialogitems, 0, 0};
...
static DIALOGITEM us_defarcdialogitems[] =
{
 ...
 /* 14 */ {0, {136,72,152,160}, EDITTEXT, x_("")},
 /* 15 */ {0, {136,16,152,64}, MESSAGE, N_("Width:")},
 /* 16 */ {0, {136,184,152,232}, MESSAGE, N_("Angle:")},
 /* 17 */ {0, {136,240,152,304}, EDITTEXT, x_("")},
 /* 18 */ {0, {160,16,176,47}, MESSAGE, N_("Pin:")},
 /* 19 */ {0, {160,48,176,358}, MESSAGE, x_("")}
};
static DIALOG us_defarcdialog = {{50,75,278,514}, N_("New Arc Options"), 0, 19, us_defarcdialogitems, 0, 0};
...
static DIALOG us_newfacetdialog = {{350,75,445,455}, N_("New Facet Creation"), 0, 7, us_newfacetdialogitems, 0, 0};
...
static DIALOG us_defnodedialog = {{50,75,535,506}, N_("New Node Options"), 0, 29, us_defnodedialogitems, 0, 0};
...
{
 /*  1 */ {0, {240,177,264,257}, BUTTON, N_("OK")},
 /*  2 */ {0, {240,16,264,96}, BUTTON, N_("Cancel")},
 /*  3 */ {0, {24,4,208,276}, SCROLL, x_("")},
 /*  4 */ {0, {4,4,20,276}, MESSAGE, N_("These options are being saved:")},
 /*  5 */ {0, {212,4,228,276}, CHECK, N_("Only show options changed this session")}
};
static DIALOG us_optsavedialog = {{75,75,348,360}, N_("Options Being Saved"), 0, 5, us_optsavedialogitems, 0, 0};
...
static DIALOGITEM us_printingoptdialogitems[] =
{
 ...
 /* 17 */ {0, {212,8,228,80}, MESSAGE, N_("For facet:")},
 ...
 /* 30 */ {0, {156,156,172,236}, MESSAGE, N_("Height (in):")},
 /* 31 */ {0, {156,240,172,280}, EDITTEXT, x_("2")},
 /* 32 */ {0, {180,20,196,256}, POPUP, x_("")},
 /* 33 */ {0, {156,292,172,372}, MESSAGE, N_("Margin (in):")},
 /* 34 */ {0, {156,376,172,416}, EDITTEXT, x_("2")},
 /* 35 */ {0, {108,228,124,304}, CHECK, N_("Flat")},
 /* 36 */ {0, {56,8,72,204}, RADIO, N_("Plot only Displayed Window")},
 /* 37 */ {0, {80,8,96,280}, MESSAGE, N_("Print and Copy resolution factor:")},
 /* 38 */ {0, {80,284,96,338}, EDITTEXT, x_("")}
};
static DIALOG us_printingoptdialog = {{50,75,431,548}, N_("Printing Options"), 0, 38, us_printingoptdialogitems, 0, 0};
...
static DIALOG proj_oldversdialog = {{108,75,318,396}, N_("Get Old Version of Facet"), 0, 5, proj_oldversdialogitems, 0, 0};
...
static DIALOGITEM us_rendialogitems[] =
{
 ...
 /*  3 */ {0, {28,8,260,220}, SCROLL, x_("")},
 /*  4 */ {0, {266,8,282,88}, MESSAGE, N_("New name:")},
 /*  5 */ {0, {266,85,282,316}, EDITTEXT, x_("")},
 /*  6 */ {0, {8,8,24,316}, POPUP, x_("")}
};
static DIALOG us_rendialog = {{75,75,366,400}, N_("Rename Object"), 0, 6, us_rendialogitems, 0, 0};

/* Routing Options */
static DIALOGITEM ro_optionsdialogitems[] =
{
 /*  1 */ {0, {240,240,264,304}, BUTTON, N_("OK")},
 /*  2 */ {0, {240,12,264,76}, BUTTON, N_("Cancel")},
 ...
 /*  7 */ {0, {116,24,132,304}, CHECK, N_("Ports must match")},
 /*  8 */ {0, {212,8,228,268}, CHECK, N_("Mimic stitching runs interactively")},
 /*  9 */ {0, {92,8,108,268}, MESSAGE, N_("Mimic stitching restrictions:")},
 /* 10 */ {0, {188,24,204,304}, CHECK, N_("Node types must match")},
 /* 11 */ {0, {164,24,180,304}, CHECK, N_("Nodes sizes must match")},
 /* 12 */ {0, {140,24,156,304}, CHECK, N_("Number of existing arcs must match")}
};
static DIALOG ro_optionsdialog = {{50,75,323,388}, N_("Routing Options"), 0, 12, ro_optionsdialogitems, 0, 0};
...
static DIALOGITEM io_skilloptionsdialogitems[] =
{
 ...
 /*  6 */ {0, {204,12,220,224}, CHECK, N_("Do not include subfacets")},
...
static DIALOGITEM sim_spiceoptdialogitems[] =
{
 ...
 /* 48 */ {0, {80,240,96,408}, CHECK, N_("Use Facet Parameters")},
 ...
 /* 54 */ {0, {104,240,120,420}, CHECK, N_("Write Trans Sizes in Lambda")},
...
static DIALOG us_seloptdialog = {{75,75,216,336}, N_("Selection Options"), 0, 6, us_seloptdialogitems, 0, 0};
...
static DIALOGITEM us_techsetdialogitems[] =
{
 ...
 /* 28 */ {0, {192,20,208,300}, CHECK, N_("Show Scalable transistors")}
};
...
static DIALOG us_deftextdialog = {{50,75,451,496}, N_("Text Options"), 0, 49, us_deftextdialogitems, 0, 0};
...
static DIALOG us_variabledialog = {{50,75,492,494}, N_("Variable Control"), 0, 37, us_variabledialogitems, 0, 0};
